use super::super::metrics::{
    NetworkMetrics, LatencyMetrics, ThroughputMetrics, ConsensusMetrics
};
...
fn test_consensus_metrics_serialization() {
    ...
    assert_eq!(consensus.finalized_tx_count, deserialized.finalized_tx_count);
...
fn test_network_metrics_serialization() {
    ...
    assert_eq!(metrics.latency.avg_latency, deserialized.latency.avg_latency);
    assert_eq!(metrics.latency.p95_latency, deserialized.latency.p95_latency);
    assert_eq!(metrics.latency.p99_latency, deserialized.latency.p99_latency);
    assert_eq!(metrics.latency.max_latency, deserialized.latency.max_latency);
    
    // Verify throughput metrics
    assert_eq!(metrics.throughput.msgs_per_sec, deserialized.throughput.msgs_per_sec);
    assert_eq!(metrics.throughput.bytes_per_sec, deserialized.throughput.bytes_per_sec);
    assert_eq!(metrics.throughput.drop_rate, deserialized.throughput.drop_rate);
    
    // Verify consensus metrics
    assert_eq!(metrics.consensus.avg_finality_time, deserialized.consensus.avg_finality_time);
    assert_eq!(metrics.consensus.finalized_tx_count, deserialized.consensus.finalized_tx_count);
    assert_eq!(metrics.consensus.pending_tx_count, deserialized.consensus.pending_tx_count);
}
...
fn test_metrics_clone() {
    ...
    assert_eq!(original.throughput.msgs_per_sec, cloned.throughput.msgs_per_sec);
    assert_eq!(original.consensus.finalized_tx_count, cloned.consensus.finalized_tx_count);
}
