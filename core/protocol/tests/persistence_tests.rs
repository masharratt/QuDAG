use qudag_protocol::{
    ...
    SqliteBackend, StatePersistence, StateProvider, PersistedPeer,
    PersistedDagState, PersistedState, CURRENT_STATE_VERSION,
    persistence::PeerStats,
};
...
async fn test_backup_and_restore() {
    ...
    // Clear state
    backend.save_state(&PersistedState {
