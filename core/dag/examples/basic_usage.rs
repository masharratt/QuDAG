...
fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let child_vertex = Vertex::new(
        child_id.clone(),
        b"Child vertex".to_vec(),
        parents,
    );
    ...
    println!("Fast finality config - Beta: {}, Alpha: {}", 
             fast_config.beta, fast_config.alpha);
    println!("High security config - Beta: {}, Alpha: {}", 
    ...
    println!("Consensus metrics - Processed: {}, Throughput: {:.2} vertices/sec", 
