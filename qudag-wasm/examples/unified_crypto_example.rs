...
use qudag_wasm::crypto_unified::{
    CryptoFeatureDetection, CryptoProvider, CurrentProvider, HashFunction, PlatformFeatures,
    QuantumResistantSigning, UnifiedBlake3, UnifiedMlDsa, get_crypto_capabilities,
};
...
fn main() {
    ...
    println!("Quantum Fingerprint: {}", PlatformFeatures::has_quantum_fingerprint());
